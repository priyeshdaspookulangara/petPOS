<?php
// This template is included by modules/accounts/expense_categories.php when $page_action is 'add' or 'edit'
// It has access to:
...
$form_mode_ec = ($page_action === 'edit') ? 'Edit' : 'Add';
$submit_action_ec = ($page_action === 'edit') ? 'edit' : 'add';

?>
<div class="container mt-4">
    <h2><?php echo $form_mode_ec; ?> Expense Category</h2>

    <form action="<?php echo htmlspecialchars($base_module_url); ?>" method="POST">
        <input type="hidden" name="form_action" value="<?php echo $submit_action_ec; ?>">
            ...
            <div class="card-body">
                ...
                <div class="form-group mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> <?php echo $form_mode_ec === 'Edit' ? 'Save Changes' : 'Add Category'; ?>
                    </button>
